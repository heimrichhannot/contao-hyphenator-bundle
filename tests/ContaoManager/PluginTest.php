...
namespace HeimrichHannot\HyphenatorBundle\Tests\ContaoManager;
...
use HeimrichHannot\HyphenatorBundle\ContaoManager\Plugin;
...
class PluginTest extends ContaoTestCase
{
    ...
    public function testGetBundles()
    {
        ...
        static::assertSame(HeimrichHannotContaoHyphenatorBundle::class, $bundles[0]->getName());
